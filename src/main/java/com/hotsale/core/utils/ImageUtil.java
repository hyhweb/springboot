...
public class ImageUtil {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        new ImageUtil().thumbnailImage(new File("e:/01.jpg"), new FileOutputStream(new File("E:/011.jpg")), 600, 600,"",false);
//        new ImageUtil().cutImage("E:/01.jpg","imgs", 250, 70, 300, 400);
    }


    public void thumbnailImage(InputStream inputStream, OutputStream output, int w, int h, String suffix, boolean force){
            try {
                // ImageIO 支持的图片类型 : [BMP, bmp, jpg, JPG, wbmp, jpeg, png, PNG, JPEG, WBMP, GIF, gif]
                String types = Arrays.toString(ImageIO.getReaderFormatNames()).replace("]", ",");
